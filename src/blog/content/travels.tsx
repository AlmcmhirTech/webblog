                ...
                <div className="grid grid-cols-[1fr_1fr_1fr] gap-10">
                    <div className="">
                        <div className="hover:bg-[#c5b6a1] p-4">
                            <a href="/webblog/tour">
                                <img className='shadow-md shadow-[#373737] opacity-90 brightness-80 mb-2' src="/webblog/src/assets/industryimmersion.jpg" alt="" />
                     ...
                     <div className="">
                        <div className="hover:bg-[#c5b6a1] p-4">
                            <a className='' href="">
                                <img className='shadow-md shadow-[#373737] opacity-100 brightness-0 mb-2' src="/webblog/src/assets/industryimmersion.jpg" alt="" />
